...
describe('Centaur', function() {
  ...
  it('should be able to sleep when laying down', function() {
    var centaur = new Centaur('George');
    centaur.layDown();
    // after this the centaur is laying down
  ...
  it('should not be cranky after sleeping', function() {
    ...
    // console.log('the test is done shooting the first time')
    assert.equal(centaur.cranky, true);
    // console.log ("the test knows i'm cranky")
    centaur.layDown();
    // console.log('the test made me laydown')
    assert.equal(centaur.sleep(), 'ZZZZ');
    // console.log('the test made me sleep')
    assert.equal(centaur.cranky, false);
    // console.log("the test knows i'm not cranky")
    centaur.standUp();
    // console.log('the test made me stand up')
    assert.equal(centaur.shoot(),'Twang!!!');
    // console.log("the test knows i was shooting")
  });
